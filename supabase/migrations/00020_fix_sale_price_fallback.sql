-- 00020_fix_sale_price_fallback.sql
-- Treat variant sale/cost price of 0 or null as unset; fall back to product base prices.
...
BEGIN
  ...
  LOOP
    ...
    SELECT COALESCE(NULLIF(pv.sale_price, 0), p.base_sale_price)
    INTO v_unit_price
