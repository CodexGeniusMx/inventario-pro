-- 00019_add_sales_notes.sql
-- Add optional notes to sales and extend create_and_complete_sale RPC.

ALTER TABLE sales
  ADD COLUMN IF NOT EXISTS notes text;

DROP FUNCTION IF EXISTS create_and_complete_sale(
  uuid, uuid, uuid, jsonb, uuid, numeric, text
);
...
BEGIN
  ...
  LOOP
    ...
    SELECT COALESCE(pv.sale_price, p.base_sale_price)
    INTO v_unit_price
